  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-xs">Manage core application configurations and global preferences.</p>
      </div>

      <SummaryCard title="System Settings" icon={Settings}>
        <div className="py-12 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xs text-slate-400 max-w-xs italic">
            We are currently building the core System Settings engine. Global parameters and integration settings will be available here soon.
          </p>
        </div>
      </SummaryCard>
    </div>
