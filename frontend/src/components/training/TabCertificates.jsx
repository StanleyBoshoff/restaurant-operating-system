...
export default function TabCertificates() {
  return (
    <div className="space-y-6">
      <SummaryCard title="Certificates" icon={Award}>
        <div className="py-12 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xs text-slate-400 max-w-xs italic">
            We are currently building the Certificates engine. Advanced tracking and analytics will be available here soon.
          </p>
        </div>
      </SummaryCard>
    </div>
