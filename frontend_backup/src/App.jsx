...
export default function App() {
  ...
  <Dashboard 
    onNavigateToEmployee={(empId) => {
      setSelectedEmployeeId(empId);   // Track targeted worker ID globally
      setCurrentModule('directory');  // Switch the active viewport screen to the Directory panel context
    }} 
  />
)}
{currentModule === 'directory' && (
  <EmployeeDirectory 
    initialViewEmployeeId={selectedEmployeeId} 
    onClearInitialView={() => setSelectedEmployeeId(null)} // Wipes memory hooks on return exits
  />
)}
